        ...
        {confirmation ? (
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-lg md:text-xl opacity-80">
              We have reserved <strong className="font-bold text-white"><span className="seat-highlight">{guestData.headCount}</span></strong> seat{guestData.headCount > 1 ? 's' : ''} in your honor.
            </motion.p>
